  ...
  return (
    <footer className="overflow-hidden bg-white px-4 pb-16 pt-24 sm:px-6 sm:pb-20 sm:pt-32 md:px-12 lg:px-24 lg:pt-52">
      ...
      <div className="mx-auto mb-16 grid max-w-[1280px] gap-12 sm:mb-24 lg:mb-40 lg:grid-cols-2 lg:gap-24">
        <div>
          <h2 className="mb-10 font-serif text-[clamp(2.5rem,7vw,6rem)] leading-[0.9] tracking-[-0.05em] sm:mb-12 lg:mb-16"><span className="text-neutral-900">Keep</span><br /><span className="italic text-neutral-300">In Touch.</span></h2>
      ...
      <div className="mx-auto flex max-w-[1280px] flex-col items-center justify-between gap-6 text-center text-[8px] font-medium uppercase tracking-[3px] text-neutral-400 sm:flex-row sm:text-left sm:text-[9px]">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-4"><span>© 2026 B-PLUM | PERSONAL PORTFOLIO</span><span className="hidden opacity-30 sm:inline">/</span><span>Crafting with passion</span></div>
