  ...
  },
  {
    ...
    locales: {
      en: {
        ...
        coverImage: { alt: "Plum.B hexagram result screen", caption: "Generated hexagram result" },
        gallery: [
          { alt: "Plum.B empty input screen", caption: "Empty input state" },
          { alt: "Plum.B ready-to-cast input screen", caption: "Ready-to-cast state" },
        ],
        sections: [
      ...
      ja: {
        ...
        coverImage: { alt: "Plum.Bの卦の結果画面", caption: "生成された卦の結果" },
        gallery: [
          { alt: "Plum.Bの未入力画面", caption: "未入力の状態" },
          { alt: "Plum.Bの占断準備完了画面", caption: "占断できる状態" },
        ],
        sections: [
          { id: "context", title: "背景と目標", content: "Plum.Bは、3つの数字で行う易の占断を、情報が詰まった道具的な画面ではなく、落ち着いて読めるモバイル体験にできないかという問いから始まりました。原典が持つ象徴の構造と文字の空気感を尊重しながら、入力から解釈までの道筋を現代のスマートフォン上で明快にすることを目指しました。" },
      ...
      zh: {
        ...
        coverImage: { alt: "Plum.B 卦象结果页面", caption: "生成的卦象结果" },
        gallery: [
          { alt: "Plum.B 空白输入页面", caption: "尚未输入的状态" },
          { alt: "Plum.B 可以起卦的输入页面", caption: "准备起卦的状态" },
        ],
        sections: [
          { id: "context", title: "背景与目标", content: "Plum.B 始于一个问题：如何把通过三个数字进行的易经占问，变成安静的移动端阅读体验，而不是信息密集的工具界面。项目希望尊重原始内容的象征结构与文字氛围，同时让用户在现代手机上从输入清晰地走向解读。" },
